	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="four columns">
				...
				<p>Welcome to Foundation for WordPress, a simple starter theme. We give you all the exceptional capabilities of ZURB's Foundation and HTML5 Boilerplate. You can remove anything you want from this page.</p>
				...
				<ul class="disc">
					...
					<li><a href="http://github.com/drewsymo/foundation">Foundation, for WordPress on Github</a><br />Latest code, issue reports, feature requests and more.</li>
					<li><a href="http://twitter.com/foundationzurb">@foundationzurb</a><br />Ping us on Twitter if you have questions. If you build something with this we'd love to see it (and send you a totally boss sticker).</li>
					<li><a href="http://twitter.com/drewsymo">@drewsymo</a><br />Follow the creator of Foundation for WordPress on Twitter</li>
