...
<body <?php body_class(); ?>>
	...
	<header>
		...
		if ( $header !== "blank" ) : ?>
		<header class="site-header" role="banner" <?php $header_image = get_header_image(); if ( ! empty( $header_image ) ) : ?> style="background:url('<?php echo esc_url( $header_image ); ?>');" <?php endif; ?>>
			<div class="row">
